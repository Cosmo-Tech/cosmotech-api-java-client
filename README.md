...
- API version: 2.4.4-dev
  - Build date: 2023-06-15T12:32:54.459528838Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.4-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.4-dev.jar`
* `target/lib/*.jar`
