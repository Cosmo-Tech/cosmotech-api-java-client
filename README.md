...
- API version: 3.0.8-SNAPSHOT
  - Build date: 2023-10-18T12:49:52.649483576Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.8-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.8-SNAPSHOT.jar`
* `target/lib/*.jar`
