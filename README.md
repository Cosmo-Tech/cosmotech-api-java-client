...
- API version: 2.3.6
  - Build date: 2023-04-11T16:43:54.946545378Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.6"
  }
```
...
* `target/cosmotech-api-java-client-2.3.6.jar`
* `target/lib/*.jar`
