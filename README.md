...
- API version: 2.1.3-dev
  - Build date: 2022-12-06T10:36:41.943277616Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.3-dev.jar`
* `target/lib/*.jar`
