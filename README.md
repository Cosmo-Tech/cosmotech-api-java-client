...
- API version: 2.3.14-private
  - Build date: 2023-07-06T14:45:58.431668593Z[Etc/UTC]
...
<dependency>
  ...
  <version>2.3.14-private</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.14-private"
  }
```
...
* `target/cosmotech-api-java-client-2.3.14-private.jar`
* `target/lib/*.jar`
