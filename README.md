...
- API version: 3.0.3-test
  - Build date: 2023-09-27T13:37:53.342702267Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.3-test"
  }
```
...
* `target/cosmotech-api-java-client-3.0.3-test.jar`
* `target/lib/*.jar`
