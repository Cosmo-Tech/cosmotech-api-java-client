...
- API version: 1.0.10-SNAPSHOT
  - Build date: 2023-01-03T16:31:59.757699373Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.10-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.10-SNAPSHOT.jar`
* `target/lib/*.jar`
