...
- API version: 2.3.4-SNAPSHOT
  - Build date: 2023-03-06T15:40:53.826926102Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.4-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.3.4-SNAPSHOT.jar`
* `target/lib/*.jar`
