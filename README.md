...
- API version: 2.3.5
  - Build date: 2023-03-07T10:30:55.699372425Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.5"
  }
```
...
* `target/cosmotech-api-java-client-2.3.5.jar`
* `target/lib/*.jar`
