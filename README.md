...
- API version: 3.1.0-dev
  - Build date: 2024-02-26T10:46:37.894118152Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.1.0-dev.jar`
* `target/lib/*.jar`
