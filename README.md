...
- API version: 2.1.12-dev
  - Build date: 2023-01-06T15:20:24.867447659Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.12-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.12-dev.jar`
* `target/lib/*.jar`
