...
- API version: 0.0.14-SNAPSHOT
  - Build date: 2022-06-13T12:06:25.436147099Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:0.0.14-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-0.0.14-SNAPSHOT.jar`
* `target/lib/*.jar`
