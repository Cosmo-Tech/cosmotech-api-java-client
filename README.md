...
- API version: 2.3.8
  - Build date: 2023-05-12T09:54:11.760779264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.8"
  }
```
...
* `target/cosmotech-api-java-client-2.3.8.jar`
* `target/lib/*.jar`
