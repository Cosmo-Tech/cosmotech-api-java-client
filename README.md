...
- API version: 2.4.2-dev
  - Build date: 2023-05-16T14:32:19.972569845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.2-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.2-dev.jar`
* `target/lib/*.jar`
