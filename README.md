...
- API version: 0.0.10-rc
  - Build date: 2021-11-18T18:50:49.496347196Z[Etc/UTC]
...
```groovy
compile "com.cosmotech:cosmotech-api-java-client:0.0.10-rc"
```
...
* `target/cosmotech-api-java-client-0.0.10-rc.jar`
* `target/lib/*.jar`
