...
- API version: 2.3.17
  - Build date: 2023-09-22T13:12:00.806656045Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.17"
  }
```
...
* `target/cosmotech-api-java-client-2.3.17.jar`
* `target/lib/*.jar`
