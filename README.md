...
- API version: 2.2.0
  - Build date: 2023-02-06T14:03:00.214652410Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.2.0"
  }
```
...
* `target/cosmotech-api-java-client-2.2.0.jar`
* `target/lib/*.jar`
