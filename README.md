...
- API version: 3.2.4
  - Build date: 2024-05-31T14:25:13.832483486Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.4"
  }
```
...
* `target/cosmotech-api-java-client-3.2.4.jar`
* `target/lib/*.jar`
