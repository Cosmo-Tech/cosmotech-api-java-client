...
- API version: 3.1.2-dev
  - Build date: 2024-03-05T15:11:31.178545951Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.2-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.1.2-dev.jar`
* `target/lib/*.jar`
