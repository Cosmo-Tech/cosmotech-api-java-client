...
- API version: 2.0.13-dev
  - Build date: 2022-11-07T15:41:23.767948866Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.13-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.13-dev.jar`
* `target/lib/*.jar`
