...
- API version: 2.4.9
  - Build date: 2023-09-22T13:08:53.024625636Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.9"
  }
```
...
* `target/cosmotech-api-java-client-2.4.9.jar`
* `target/lib/*.jar`
