...
- API version: 0.0.4-SNAPSHOT
  - Build date: 2021-05-28T14:14:45.603032+02:00[Europe/Paris]
...
```groovy
compile "com.cosmotech:cosmotech-api-java-client:0.0.4-SNAPSHOT"
```
...
* `target/cosmotech-api-java-client-0.0.4-SNAPSHOT.jar`
* `target/lib/*.jar`
