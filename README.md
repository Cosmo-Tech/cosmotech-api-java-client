...
- API version: 1.0.3-pr
  - Build date: 2022-08-01T15:26:22.022492851Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.3-pr"
  }
```
...
* `target/cosmotech-api-java-client-1.0.3-pr.jar`
* `target/lib/*.jar`
