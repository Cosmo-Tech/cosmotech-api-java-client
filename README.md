...
- API version: 2.1.7-dev
  - Build date: 2023-01-03T17:11:17.574373480Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.7-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.7-dev.jar`
* `target/lib/*.jar`
