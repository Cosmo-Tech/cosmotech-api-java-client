...
- API version: 3.0.1-SNAPSHOT
  - Build date: 2024-01-19T16:00:24.956323347Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.1-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.1-SNAPSHOT.jar`
* `target/lib/*.jar`
