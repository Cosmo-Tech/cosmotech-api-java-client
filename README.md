...
- API version: 1.0.0-dev
  - Build date: 2022-06-24T10:15:06.413137358Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.0-dev.jar`
* `target/lib/*.jar`
