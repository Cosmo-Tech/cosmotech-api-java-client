...
- API version: 2.3.1-dev
  - Build date: 2023-02-15T10:42:18.335296895Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.1-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.1-dev.jar`
* `target/lib/*.jar`
