...
- API version: 3.2.1
  - Build date: 2024-05-20T13:04:46.423324495Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.1"
  }
```
...
* `target/cosmotech-api-java-client-3.2.1.jar`
* `target/lib/*.jar`
