...
- API version: 2.4.3-dev
  - Build date: 2023-05-30T13:20:41.466929757Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.3-dev.jar`
* `target/lib/*.jar`
