...
- API version: 2.3.5-rc
  - Build date: 2023-03-06T14:37:32.127842344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.5-rc"
  }
```
...
* `target/cosmotech-api-java-client-2.3.5-rc.jar`
* `target/lib/*.jar`
