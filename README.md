...
- API version: 3.0.12-dev
  - Build date: 2023-11-13T13:55:43.440724681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.12-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.12-dev.jar`
* `target/lib/*.jar`
