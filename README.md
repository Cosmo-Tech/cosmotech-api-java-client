...
- API version: 2.1.6-dev
  - Build date: 2022-12-09T12:26:04.305355958Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.6-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.6-dev.jar`
* `target/lib/*.jar`
