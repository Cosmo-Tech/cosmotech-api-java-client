...
- API version: 0.0.13-rc
  - Build date: 2022-05-05T12:10:42.206597073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:0.0.13-rc"
  }
```
...
* `target/cosmotech-api-java-client-0.0.13-rc.jar`
* `target/lib/*.jar`
