...
- API version: 1.0.0-rc
  - Build date: 2022-06-24T10:15:29.123907216Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.0-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.0.0-rc.jar`
* `target/lib/*.jar`
