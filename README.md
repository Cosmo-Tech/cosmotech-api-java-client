...
- API version: 3.0.5
  - Build date: 2024-05-06T07:05:53.915376903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.5"
  }
```
...
* `target/cosmotech-api-java-client-3.0.5.jar`
* `target/lib/*.jar`
