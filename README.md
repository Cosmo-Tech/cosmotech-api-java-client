...
- API version: 3.0.7-dev
  - Build date: 2023-10-13T11:12:03.755703483Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.7-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.7-dev.jar`
* `target/lib/*.jar`
