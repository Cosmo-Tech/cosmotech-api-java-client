...
- API version: 2.3.12-private
  - Build date: 2023-06-23T14:32:07.612493091Z[Etc/UTC]
...
<dependency>
  ...
  <version>2.3.12-private</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.12-private"
  }
```
...
* `target/cosmotech-api-java-client-2.3.12-private.jar`
* `target/lib/*.jar`
