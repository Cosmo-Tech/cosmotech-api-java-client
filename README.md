...
- API version: 2.4.1-dev
  - Build date: 2023-05-11T10:14:36.782850542Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.1-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.1-dev.jar`
* `target/lib/*.jar`
