...
- API version: 3.1.8-adp
  - Build date: 2024-06-05T07:56:26.933478807Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.8-adp"
  }
```
...
* `target/cosmotech-api-java-client-3.1.8-adp.jar`
* `target/lib/*.jar`
