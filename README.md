...
- API version: 3.0.6-dev
  - Build date: 2023-10-12T15:50:56.674920693Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.6-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.6-dev.jar`
* `target/lib/*.jar`
