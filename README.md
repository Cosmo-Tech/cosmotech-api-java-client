...
- API version: 3.0.3-dev
  - Build date: 2023-10-11T08:40:23.472802426Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.3-dev.jar`
* `target/lib/*.jar`
