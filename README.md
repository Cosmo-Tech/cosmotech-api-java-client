...
- API version: 3.1.1-dev
  - Build date: 2024-02-29T14:34:52.169383607Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.1-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.1.1-dev.jar`
* `target/lib/*.jar`
