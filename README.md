...
- API version: 2.0.5-dev
  - Build date: 2022-10-10T09:44:21.078676797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.5-dev.jar`
* `target/lib/*.jar`
