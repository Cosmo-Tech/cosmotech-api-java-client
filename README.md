...
- API version: 3.0.11-SNAPSHOT
  - Build date: 2023-11-06T09:50:53.129218345Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.11-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.11-SNAPSHOT.jar`
* `target/lib/*.jar`
