...
- API version: 3.2.6
  - Build date: 2024-06-18T12:26:15.435424359Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.6"
  }
```
...
* `target/cosmotech-api-java-client-3.2.6.jar`
* `target/lib/*.jar`
