...
- API version: 3.0.3
  - Build date: 2024-03-11T09:27:48.849244554Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.3"
  }
```
...
* `target/cosmotech-api-java-client-3.0.3.jar`
* `target/lib/*.jar`
