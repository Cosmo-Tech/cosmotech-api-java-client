...
- API version: 1.0.0
  - Build date: 2022-06-24T10:15:58.251201482Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.0"
  }
```
...
* `target/cosmotech-api-java-client-1.0.0.jar`
* `target/lib/*.jar`
