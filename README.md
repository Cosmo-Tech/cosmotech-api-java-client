...
- API version: 2.0.4-dev
  - Build date: 2022-10-07T17:17:12.559314903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.4-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.4-dev.jar`
* `target/lib/*.jar`
