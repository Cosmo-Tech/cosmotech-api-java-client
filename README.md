...
- API version: 3.1.6
  - Build date: 2024-05-28T13:09:53.752822870Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.6"
  }
```
...
* `target/cosmotech-api-java-client-3.1.6.jar`
* `target/lib/*.jar`
