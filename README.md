...
- API version: 1.0.7-SNAPSHOT
  - Build date: 2022-09-13T18:19:19.016404773Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.7-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.7-SNAPSHOT.jar`
* `target/lib/*.jar`
