...
- API version: 3.0.0-test
  - Build date: 2023-09-13T15:35:49.652884302Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.0-test"
  }
```
...
* `target/cosmotech-api-java-client-3.0.0-test.jar`
* `target/lib/*.jar`
