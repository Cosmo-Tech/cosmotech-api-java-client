...
- API version: 2.4.0-dev
  - Build date: 2023-04-27T14:17:03.873957266Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.0-dev.jar`
* `target/lib/*.jar`
