...
- API version: 2.3.10
  - Build date: 2023-06-06T13:35:32.214481849Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.10"
  }
```
...
* `target/cosmotech-api-java-client-2.3.10.jar`
* `target/lib/*.jar`
