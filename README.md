...
- API version: 2.4.3-SNAPSHOT
  - Build date: 2023-05-29T16:10:41.398926567Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.3-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.4.3-SNAPSHOT.jar`
* `target/lib/*.jar`
