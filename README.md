...
- API version: 2.0.10-dev
  - Build date: 2022-10-28T15:22:13.624112273Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.10-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.10-dev.jar`
* `target/lib/*.jar`
