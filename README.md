...
- API version: 1.0.1-dev
  - Build date: 2022-07-13T15:21:36.994583727Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.1-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.1-dev.jar`
* `target/lib/*.jar`
