...
- API version: 1.0.4-SNAPSHOT
  - Build date: 2022-08-02T23:22:41.603470454Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.4-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.4-SNAPSHOT.jar`
* `target/lib/*.jar`
