...
- API version: 2.4.1-SNAPSHOT
  - Build date: 2023-05-05T15:32:44.774651405Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.1-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.4.1-SNAPSHOT.jar`
* `target/lib/*.jar`
