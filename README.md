...
- API version: 2.0.7-dev
  - Build date: 2022-10-21T12:37:49.976468203Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.7-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.7-dev.jar`
* `target/lib/*.jar`
