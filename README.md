...
- API version: 2.2.0-dev
  - Build date: 2023-01-06T16:49:24.965754571Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.2.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.2.0-dev.jar`
* `target/lib/*.jar`
