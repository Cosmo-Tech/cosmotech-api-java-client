...
- API version: 1.1.3-SNAPSHOT
  - Build date: 2023-02-09T14:54:50.154566011Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.3-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.1.3-SNAPSHOT.jar`
* `target/lib/*.jar`
