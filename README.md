...
- API version: 2.1.5-dev
  - Build date: 2022-12-09T12:10:55.986385794Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.5-dev.jar`
* `target/lib/*.jar`
