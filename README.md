...
- API version: 2.4.3-preview
  - Build date: 2023-06-02T13:46:08.125436448Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.3-preview"
  }
```
...
* `target/cosmotech-api-java-client-2.4.3-preview.jar`
* `target/lib/*.jar`
