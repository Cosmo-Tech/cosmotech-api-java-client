...
- API version: 2.1.8-dev
  - Build date: 2023-01-03T18:09:22.969443075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.8-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.8-dev.jar`
* `target/lib/*.jar`
