...
- API version: 2.0.0
  - Build date: 2022-11-08T16:50:09.541416307Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.0"
  }
```
...
* `target/cosmotech-api-java-client-2.0.0.jar`
* `target/lib/*.jar`
