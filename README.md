...
- API version: 3.1.0
  - Build date: 2024-03-07T14:04:20.793755959Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.0"
  }
```
...
* `target/cosmotech-api-java-client-3.1.0.jar`
* `target/lib/*.jar`
