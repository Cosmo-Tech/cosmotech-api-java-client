...
- API version: 2.3.15-private
  - Build date: 2023-07-07T07:06:32.315793449Z[Etc/UTC]
...
<dependency>
  ...
  <version>2.3.15-private</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.15-private"
  }
```
...
* `target/cosmotech-api-java-client-2.3.15-private.jar`
* `target/lib/*.jar`
