...
- API version: 1.0.6-rc
  - Build date: 2022-09-13T17:59:19.104429178Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.6-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.0.6-rc.jar`
* `target/lib/*.jar`
