...
- API version: 1.1.0
  - Build date: 2023-01-03T17:25:21.471130429Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.0"
  }
```
...
* `target/cosmotech-api-java-client-1.1.0.jar`
* `target/lib/*.jar`
