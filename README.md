...
- API version: 0.0.10-dev
  - Build date: 2021-11-18T18:20:19.467398605Z[Etc/UTC]
...
```groovy
compile "com.cosmotech:cosmotech-api-java-client:0.0.10-dev"
```
...
* `target/cosmotech-api-java-client-0.0.10-dev.jar`
* `target/lib/*.jar`
