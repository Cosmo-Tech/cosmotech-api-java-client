...
- API version: 3.1.4
  - Build date: 2024-04-22T15:21:26.429591157Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.4"
  }
```
...
* `target/cosmotech-api-java-client-3.1.4.jar`
* `target/lib/*.jar`
