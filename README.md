...
- API version: 4.0.0-onprem
  - Build date: 2024-06-27T08:44:41.968382564Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:4.0.0-onprem"
  }
```
...
* `target/cosmotech-api-java-client-4.0.0-onprem.jar`
* `target/lib/*.jar`
