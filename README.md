...
- API version: 3.1.9
  - Build date: 2024-06-05T13:51:22.106921124Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.9"
  }
```
...
* `target/cosmotech-api-java-client-3.1.9.jar`
* `target/lib/*.jar`
