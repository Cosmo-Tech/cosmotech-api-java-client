...
- API version: 1.1.2-dev
  - Build date: 2023-01-06T17:21:41.191632997Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.2-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.1.2-dev.jar`
* `target/lib/*.jar`
