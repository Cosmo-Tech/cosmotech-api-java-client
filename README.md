...
- API version: 2.1.9-dev
  - Build date: 2023-01-04T08:16:57.506317330Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.9-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.9-dev.jar`
* `target/lib/*.jar`
