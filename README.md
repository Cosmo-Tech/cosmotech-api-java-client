...
- API version: 2.0.8-dev
  - Build date: 2022-10-25T12:37:57.407549695Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.8-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.8-dev.jar`
* `target/lib/*.jar`
