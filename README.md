...
- API version: 3.0.16-SNAPSHOT
  - Build date: 2023-12-20T13:33:21.643874989Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.16-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.16-SNAPSHOT.jar`
* `target/lib/*.jar`
