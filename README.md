...
- API version: 2.0.12-dev
  - Build date: 2022-11-07T11:01:47.379297483Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.12-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.12-dev.jar`
* `target/lib/*.jar`
