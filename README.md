...
- API version: 3.0.12-SNAPSHOT
  - Build date: 2023-11-13T13:20:17.172727254Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.12-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.12-SNAPSHOT.jar`
* `target/lib/*.jar`
