...
- API version: 1.0.8-SNAPSHOT
  - Build date: 2022-09-29T15:22:06.076090389Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.8-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.8-SNAPSHOT.jar`
* `target/lib/*.jar`
