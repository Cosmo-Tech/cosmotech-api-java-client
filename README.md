...
- API version: 1.1.0-rc
  - Build date: 2023-01-03T17:24:38.246407365Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.0-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.1.0-rc.jar`
* `target/lib/*.jar`
