...
- API version: 1.0.2-dev
  - Build date: 2022-07-28T15:26:01.717823093Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.2-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.2-dev.jar`
* `target/lib/*.jar`
