...
- API version: 2.1.9-SNAPSHOT
  - Build date: 2023-01-06T15:39:34.376413522Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.9-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.1.9-SNAPSHOT.jar`
* `target/lib/*.jar`
