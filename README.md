...
- API version: 3.0.18-dev
  - Build date: 2023-12-05T08:58:25.807924993Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.18-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.18-dev.jar`
* `target/lib/*.jar`
