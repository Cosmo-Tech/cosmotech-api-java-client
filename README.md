...
- API version: 3.0.9-SNAPSHOT
  - Build date: 2023-10-19T12:37:26.620429577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.9-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.9-SNAPSHOT.jar`
* `target/lib/*.jar`
