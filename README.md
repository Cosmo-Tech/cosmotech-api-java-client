...
- API version: 2.3.1-rc
  - Build date: 2023-02-16T09:13:13.743879991Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.1-rc"
  }
```
...
* `target/cosmotech-api-java-client-2.3.1-rc.jar`
* `target/lib/*.jar`
