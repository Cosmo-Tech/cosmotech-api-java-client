...
- API version: 4.0.1-onprem
  - Build date: 2024-07-03T16:11:02.424260350Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:4.0.1-onprem"
  }
```
...
* `target/cosmotech-api-java-client-4.0.1-onprem.jar`
* `target/lib/*.jar`
