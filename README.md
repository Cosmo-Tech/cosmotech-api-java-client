...
- API version: 3.1.3-SNAPSHOT
  - Build date: 2024-03-07T10:07:04.922079364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.3-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.1.3-SNAPSHOT.jar`
* `target/lib/*.jar`
