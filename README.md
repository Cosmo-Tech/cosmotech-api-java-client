...
- API version: 3.0.0-dev
  - Build date: 2022-10-20T15:29:17.610798058Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.0-dev.jar`
* `target/lib/*.jar`
