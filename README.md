...
- API version: 1.1.0-dev
  - Build date: 2023-01-03T17:23:57.121932373Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.1.0-dev.jar`
* `target/lib/*.jar`
