...
- API version: 1.1.1-dev
  - Build date: 2023-01-06T16:03:03.039736815Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.1-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.1.1-dev.jar`
* `target/lib/*.jar`
