...
- API version: 3.0.18-SNAPSHOT
  - Build date: 2023-12-05T08:55:13.581515453Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.18-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.18-SNAPSHOT.jar`
* `target/lib/*.jar`
