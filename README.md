...
- API version: 3.1.2-SNAPSHOT
  - Build date: 2024-03-05T10:16:25.678426608Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.2-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.1.2-SNAPSHOT.jar`
* `target/lib/*.jar`
