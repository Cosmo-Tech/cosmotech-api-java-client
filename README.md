...
- API version: 1.1.1
  - Build date: 2023-01-06T16:03:39.169082561Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.1"
  }
```
...
* `target/cosmotech-api-java-client-1.1.1.jar`
* `target/lib/*.jar`
