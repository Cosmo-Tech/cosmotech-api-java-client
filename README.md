...
- API version: 1.1.2-SNAPSHOT
  - Build date: 2023-01-06T17:19:43.026735870Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.2-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.1.2-SNAPSHOT.jar`
* `target/lib/*.jar`
