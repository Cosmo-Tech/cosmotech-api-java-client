...
- API version: 1.0.3-SNAPSHOT
  - Build date: 2022-07-28T16:59:29.514348495Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.3-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.3-SNAPSHOT.jar`
* `target/lib/*.jar`
