...
- API version: 2.1.10-dev
  - Build date: 2023-01-04T10:15:39.635268157Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.10-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.10-dev.jar`
* `target/lib/*.jar`
