...
- API version: 2.0.3-dev
  - Build date: 2022-10-07T17:10:34.261993061Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.3-dev.jar`
* `target/lib/*.jar`
