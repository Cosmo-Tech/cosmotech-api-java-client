...
- API version: 2.1.4-dev
  - Build date: 2022-12-09T11:42:01.410519693Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.4-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.4-dev.jar`
* `target/lib/*.jar`
