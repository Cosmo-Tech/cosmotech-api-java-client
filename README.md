...
- API version: 2.3.11
  - Build date: 2023-06-14T09:12:21.858332756Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.11"
  }
```
...
* `target/cosmotech-api-java-client-2.3.11.jar`
* `target/lib/*.jar`
