...
- API version: 3.1.8
  - Build date: 2024-05-31T14:25:19.437160667Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.8"
  }
```
...
* `target/cosmotech-api-java-client-3.1.8.jar`
* `target/lib/*.jar`
