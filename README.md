...
- API version: 3.2.7
  - Build date: 2024-06-27T12:27:08.224198532Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.7"
  }
```
...
* `target/cosmotech-api-java-client-3.2.7.jar`
* `target/lib/*.jar`
