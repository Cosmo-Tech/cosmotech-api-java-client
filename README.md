...
- API version: 3.0.2
  - Build date: 2024-02-02T13:52:21.311472159Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.2"
  }
```
...
* `target/cosmotech-api-java-client-3.0.2.jar`
* `target/lib/*.jar`
