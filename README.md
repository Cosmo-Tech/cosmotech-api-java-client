...
- API version: 3.0.9-dev
  - Build date: 2023-10-30T10:42:19.684557673Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.9-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.9-dev.jar`
* `target/lib/*.jar`
