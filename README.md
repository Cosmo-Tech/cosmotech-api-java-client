...
- API version: 1.0.9-dev
  - Build date: 2023-01-03T16:23:36.577913023Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.9-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.9-dev.jar`
* `target/lib/*.jar`
