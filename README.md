...
- API version: 3.0.13-SNAPSHOT
  - Build date: 2023-11-13T16:24:56.035931305Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.13-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.13-SNAPSHOT.jar`
* `target/lib/*.jar`
