...
- API version: 2.4.8
  - Build date: 2023-09-21T12:29:58.835980255Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.8"
  }
```
...
* `target/cosmotech-api-java-client-2.4.8.jar`
* `target/lib/*.jar`
