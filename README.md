...
- API version: 3.0.10-SNAPSHOT
  - Build date: 2023-11-02T15:39:42.022426613Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.10-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.10-SNAPSHOT.jar`
* `target/lib/*.jar`
