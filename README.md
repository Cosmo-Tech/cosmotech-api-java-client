...
- API version: 2.3.8-SNAPSHOT
  - Build date: 2023-04-27T14:14:50.632099952Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.8-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.3.8-SNAPSHOT.jar`
* `target/lib/*.jar`
