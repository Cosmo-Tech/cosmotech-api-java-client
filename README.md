...
- API version: 0.0.11-rc
  - Build date: 2022-03-15T07:43:48.043049238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:0.0.11-rc"
  }
```
...
* `target/cosmotech-api-java-client-0.0.11-rc.jar`
* `target/lib/*.jar`
