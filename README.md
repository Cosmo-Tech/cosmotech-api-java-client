...
- API version: 1.1.1-SNAPSHOT
  - Build date: 2023-01-03T17:37:19.747893521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.1-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.1.1-SNAPSHOT.jar`
* `target/lib/*.jar`
