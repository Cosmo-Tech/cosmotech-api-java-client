...
- API version: 2.3.5-dev
  - Build date: 2023-02-24T11:06:44.189036384Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.5-dev.jar`
* `target/lib/*.jar`
