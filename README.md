...
- API version: 2.4.5-dev
  - Build date: 2023-06-23T14:03:13.124475789Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.4.5-dev.jar`
* `target/lib/*.jar`
