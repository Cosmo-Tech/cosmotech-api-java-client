...
- API version: 2.0.4-SNAPSHOT
  - Build date: 2022-10-28T13:37:43.224979675Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.4-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.0.4-SNAPSHOT.jar`
* `target/lib/*.jar`
