...
- API version: 1.1.2
  - Build date: 2023-01-10T14:32:49.399075201Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.2"
  }
```
...
* `target/cosmotech-api-java-client-1.1.2.jar`
* `target/lib/*.jar`
