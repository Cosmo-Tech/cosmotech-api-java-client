...
- API version: 3.0.7-SNAPSHOT
  - Build date: 2023-10-13T11:10:59.262457421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.7-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.7-SNAPSHOT.jar`
* `target/lib/*.jar`
