...
- API version: 0.0.2-SNAPSHOT
  - Build date: 2021-05-18T18:17:46.946024+02:00[Europe/Paris]
...
```groovy
compile "com.cosmotech:cosmotech-api-java-client:0.0.2-SNAPSHOT"
```
...
* `target/cosmotech-api-java-client-0.0.2-SNAPSHOT.jar`
* `target/lib/*.jar`
