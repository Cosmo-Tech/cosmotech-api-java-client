...
- API version: 3.0.15-dev
  - Build date: 2023-12-15T09:32:21.264165260Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.15-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.15-dev.jar`
* `target/lib/*.jar`
