...
- API version: 2.4.5-private
  - Build date: 2023-06-23T14:54:00.574335730Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.5-private"
  }
```
...
* `target/cosmotech-api-java-client-2.4.5-private.jar`
* `target/lib/*.jar`
