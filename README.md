...
- API version: 3.2.3
  - Build date: 2024-05-28T13:52:09.642020162Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.3"
  }
```
...
* `target/cosmotech-api-java-client-3.2.3.jar`
* `target/lib/*.jar`
