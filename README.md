...
- API version: 2.3.7-SNAPSHOT
  - Build date: 2023-04-27T11:44:37.401847806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.7-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.3.7-SNAPSHOT.jar`
* `target/lib/*.jar`
