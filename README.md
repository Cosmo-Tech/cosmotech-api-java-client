...
- API version: 3.0.17-dev
  - Build date: 2023-12-01T09:41:17.177798079Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.17-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.17-dev.jar`
* `target/lib/*.jar`
