...
- API version: 3.1.1
  - Build date: 2024-03-13T09:52:16.554831175Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.1.1"
  }
```
...
* `target/cosmotech-api-java-client-3.1.1.jar`
* `target/lib/*.jar`
