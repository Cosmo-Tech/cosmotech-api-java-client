...
- API version: 2.3.0-dev
  - Build date: 2023-02-09T15:05:07.028124486Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.0-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.0-dev.jar`
* `target/lib/*.jar`
