...
- API version: 2.4.10
  - Build date: 2023-11-28T13:47:41.193072794Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.10"
  }
```
...
* `target/cosmotech-api-java-client-2.4.10.jar`
* `target/lib/*.jar`
