...
- API version: 2.3.6-dev
  - Build date: 2023-03-27T15:08:47.381947293Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.6-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.6-dev.jar`
* `target/lib/*.jar`
