...
- API version: 3.0.6-SNAPSHOT
  - Build date: 2023-10-12T15:42:38.886130950Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.6-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.6-SNAPSHOT.jar`
* `target/lib/*.jar`
