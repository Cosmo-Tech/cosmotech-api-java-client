...
- API version: 3.0.1-test
  - Build date: 2023-09-21T10:20:13.802740111Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.1-test"
  }
```
...
* `target/cosmotech-api-java-client-3.0.1-test.jar`
* `target/lib/*.jar`
