...
- API version: 2.1.6
  - Build date: 2022-12-09T12:54:50.491099741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.6"
  }
```
...
* `target/cosmotech-api-java-client-2.1.6.jar`
* `target/lib/*.jar`
