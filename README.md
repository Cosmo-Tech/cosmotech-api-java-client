...
- API version: 3.0.4-SNAPSHOT
  - Build date: 2023-10-12T10:00:29.320936458Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.4-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.4-SNAPSHOT.jar`
* `target/lib/*.jar`
