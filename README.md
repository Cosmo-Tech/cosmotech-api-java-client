...
- API version: 2.4.11
  - Build date: 2024-03-11T09:48:36.421808564Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.11"
  }
```
...
* `target/cosmotech-api-java-client-2.4.11.jar`
* `target/lib/*.jar`
