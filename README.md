...
- API version: 1.0.5-dev
  - Build date: 2022-08-31T12:30:35.855591225Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.5-dev.jar`
* `target/lib/*.jar`
