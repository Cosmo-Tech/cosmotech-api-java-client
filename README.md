...
- API version: 1.0.5-SNAPSHOT
  - Build date: 2022-08-30T09:35:53.439543126Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.5-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.5-SNAPSHOT.jar`
* `target/lib/*.jar`
