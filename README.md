...
- API version: 3.0.17-SNAPSHOT
  - Build date: 2023-12-01T09:36:05.550512012Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.17-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-3.0.17-SNAPSHOT.jar`
* `target/lib/*.jar`
