...
- API version: 2.3.13-private
  - Build date: 2023-06-28T14:34:44.866715799Z[Etc/UTC]
...
<dependency>
  ...
  <version>2.3.13-private</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.13-private"
  }
```
...
* `target/cosmotech-api-java-client-2.3.13-private.jar`
* `target/lib/*.jar`
