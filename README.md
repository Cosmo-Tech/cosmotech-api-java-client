...
- API version: 3.0.1
  - Build date: 2024-01-29T15:12:13.924858745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.1"
  }
```
...
* `target/cosmotech-api-java-client-3.0.1.jar`
* `target/lib/*.jar`
