...
- API version: 3.0.4-dev
  - Build date: 2023-10-12T10:03:07.464325372Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.4-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.4-dev.jar`
* `target/lib/*.jar`
