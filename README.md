...
- API version: 2.1.11-dev
  - Build date: 2023-01-05T18:24:43.891462813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.11-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.11-dev.jar`
* `target/lib/*.jar`
