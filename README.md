...
- API version: 1.0.7-rc
  - Build date: 2022-09-13T18:20:59.348871634Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.7-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.0.7-rc.jar`
* `target/lib/*.jar`
