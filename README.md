...
- API version: 1.0.9-SNAPSHOT
  - Build date: 2023-01-03T08:09:32.438708521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.9-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.9-SNAPSHOT.jar`
* `target/lib/*.jar`
