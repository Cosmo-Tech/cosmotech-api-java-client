...
- API version: 2.4.7-private
  - Build date: 2023-07-07T07:07:31.277165109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.7-private"
  }
```
...
* `target/cosmotech-api-java-client-2.4.7-private.jar`
* `target/lib/*.jar`
