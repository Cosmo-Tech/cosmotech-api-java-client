...
- API version: 1.0.8
  - Build date: 2022-11-24T16:06:21.890380062Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.8"
  }
```
...
* `target/cosmotech-api-java-client-1.0.8.jar`
* `target/lib/*.jar`
