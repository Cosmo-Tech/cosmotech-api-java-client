...
- API version: 1.1.2-rc
  - Build date: 2023-01-10T14:32:23.795531089Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.2-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.1.2-rc.jar`
* `target/lib/*.jar`
