...
- API version: 2.4.4-SNAPSHOT
  - Build date: 2023-06-15T10:06:48.847683917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.4-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.4.4-SNAPSHOT.jar`
* `target/lib/*.jar`
