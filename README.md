...
- API version: 1.0.1-SNAPSHOT
  - Build date: 2022-07-12T12:13:10.148041623Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.1-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.1-SNAPSHOT.jar`
* `target/lib/*.jar`
