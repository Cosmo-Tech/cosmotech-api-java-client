...
- API version: 1.0.2-SNAPSHOT
  - Build date: 2022-07-26T16:41:30.132978180Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.2-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.2-SNAPSHOT.jar`
* `target/lib/*.jar`
