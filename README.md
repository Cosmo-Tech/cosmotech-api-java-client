...
- API version: 3.0.5-dev
  - Build date: 2023-10-12T13:52:45.237044073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.5-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.5-dev.jar`
* `target/lib/*.jar`
