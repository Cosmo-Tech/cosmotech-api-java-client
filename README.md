...
- API version: 2.4.2-SNAPSHOT
  - Build date: 2023-05-16T12:43:11.672800006Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.2-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-2.4.2-SNAPSHOT.jar`
* `target/lib/*.jar`
