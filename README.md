...
- API version: 2.3.9
  - Build date: 2023-05-17T07:33:59.508547375Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.9"
  }
```
...
* `target/cosmotech-api-java-client-2.3.9.jar`
* `target/lib/*.jar`
