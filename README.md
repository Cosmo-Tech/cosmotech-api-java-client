...
- API version: 2.3.9-rc
  - Build date: 2023-05-16T14:38:30.551069041Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.9-rc"
  }
```
...
* `target/cosmotech-api-java-client-2.3.9-rc.jar`
* `target/lib/*.jar`
