...
- API version: 3.0.13-dev
  - Build date: 2023-11-15T14:51:53.800466706Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.13-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.13-dev.jar`
* `target/lib/*.jar`
