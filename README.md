...
- API version: 4.0.2-onprem
  - Build date: 2024-07-15T15:29:24.019802059Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:4.0.2-onprem"
  }
```
...
* `target/cosmotech-api-java-client-4.0.2-onprem.jar`
* `target/lib/*.jar`
