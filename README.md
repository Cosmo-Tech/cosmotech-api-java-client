...
- API version: 2.3.3-dev
  - Build date: 2023-02-20T20:28:44.368255968Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.3-dev.jar`
* `target/lib/*.jar`
