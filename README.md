...
- API version: 2.4.7-public
  - Build date: 2023-08-30T14:48:50.660925149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.4.7-public"
  }
```
...
* `target/cosmotech-api-java-client-2.4.7-public.jar`
* `target/lib/*.jar`
