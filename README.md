...
- API version: 1.0.6-SNAPSHOT
  - Build date: 2022-09-06T15:09:52.312326494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.6-SNAPSHOT"
  }
```
...
* `target/cosmotech-api-java-client-1.0.6-SNAPSHOT.jar`
* `target/lib/*.jar`
