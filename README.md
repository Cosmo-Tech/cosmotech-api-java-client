...
- API version: 2.1.2-dev
  - Build date: 2022-12-02T13:43:57.973221457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.1.2-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.1.2-dev.jar`
* `target/lib/*.jar`
