...
- API version: 3.0.0
  - Build date: 2024-01-19T15:33:41.631882639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.0"
  }
```
...
* `target/cosmotech-api-java-client-3.0.0.jar`
* `target/lib/*.jar`
