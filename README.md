...
- API version: 3.0.8-dev
  - Build date: 2023-10-18T13:56:50.785483120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.8-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.8-dev.jar`
* `target/lib/*.jar`
