...
- API version: 2.3.4-dev
  - Build date: 2023-02-20T21:14:08.674412920Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.3.4-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.3.4-dev.jar`
* `target/lib/*.jar`
