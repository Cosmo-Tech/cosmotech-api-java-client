...
- API version: 1.0.7
  - Build date: 2022-09-13T18:47:07.100788416Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.7"
  }
```
...
* `target/cosmotech-api-java-client-1.0.7.jar`
* `target/lib/*.jar`
