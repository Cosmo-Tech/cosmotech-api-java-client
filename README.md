...
- API version: 3.0.10-dev
  - Build date: 2023-11-02T15:43:37.383891944Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.10-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.10-dev.jar`
* `target/lib/*.jar`
