...
- API version: 1.0.3-dev
  - Build date: 2022-08-02T14:51:32.226946893Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.3-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.3-dev.jar`
* `target/lib/*.jar`
