...
- API version: 3.0.2-test
  - Build date: 2023-09-26T14:08:02.138729865Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.2-test"
  }
```
...
* `target/cosmotech-api-java-client-3.0.2-test.jar`
* `target/lib/*.jar`
