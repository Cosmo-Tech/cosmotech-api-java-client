...
- API version: 2.0.6-dev
  - Build date: 2022-10-14T13:50:17.155761360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:2.0.6-dev"
  }
```
...
* `target/cosmotech-api-java-client-2.0.6-dev.jar`
* `target/lib/*.jar`
