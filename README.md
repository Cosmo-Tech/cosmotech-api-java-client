...
- API version: 1.1.1-rc
  - Build date: 2023-01-06T16:03:21.642309161Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.1.1-rc"
  }
```
...
* `target/cosmotech-api-java-client-1.1.1-rc.jar`
* `target/lib/*.jar`
