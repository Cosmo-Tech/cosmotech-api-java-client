...
- API version: 1.0.6-dev
  - Build date: 2022-09-13T17:10:57.360262304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:1.0.6-dev"
  }
```
...
* `target/cosmotech-api-java-client-1.0.6-dev.jar`
* `target/lib/*.jar`
