...
- API version: 3.2.8
  - Build date: 2024-07-16T12:45:04.926402752Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.2.8"
  }
```
...
* `target/cosmotech-api-java-client-3.2.8.jar`
* `target/lib/*.jar`
