...
- API version: 3.0.11-dev
  - Build date: 2023-11-13T09:23:34.747726426Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.cosmotech:cosmotech-api-java-client:3.0.11-dev"
  }
```
...
* `target/cosmotech-api-java-client-3.0.11-dev.jar`
* `target/lib/*.jar`
