...
public class ScenariorunApi {
    ...
    /**
     * Build call for importScenarioRun
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
     * @param scenarioRun the ScenarioRun to import (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importScenarioRunCall(String organizationId, String workspaceId, String scenarioId, ScenarioRun scenarioRun, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = scenarioRun;

        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/run/import"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()))
            .replaceAll("\\{" + "workspace_id" + "\\}", localVarApiClient.escapeString(workspaceId.toString()))
            .replaceAll("\\{" + "scenario_id" + "\\}", localVarApiClient.escapeString(scenarioId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importScenarioRunValidateBeforeCall(String organizationId, String workspaceId, String scenarioId, ScenarioRun scenarioRun, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling importScenarioRun(Async)");
        }
        
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling importScenarioRun(Async)");
        }
        
        // verify the required parameter 'scenarioId' is set
        if (scenarioId == null) {
            throw new ApiException("Missing the required parameter 'scenarioId' when calling importScenarioRun(Async)");
        }
        
        // verify the required parameter 'scenarioRun' is set
        if (scenarioRun == null) {
            throw new ApiException("Missing the required parameter 'scenarioRun' when calling importScenarioRun(Async)");
        }
        

        okhttp3.Call localVarCall = importScenarioRunCall(organizationId, workspaceId, scenarioId, scenarioRun, _callback);
        return localVarCall;
     ...
     */
    public ScenarioRun importScenarioRun(String organizationId, String workspaceId, String scenarioId, ScenarioRun scenarioRun) throws ApiException {
        ApiResponse<ScenarioRun> localVarResp = importScenarioRunWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRun);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ScenarioRun> importScenarioRunWithHttpInfo(String organizationId, String workspaceId, String scenarioId, ScenarioRun scenarioRun) throws ApiException {
        okhttp3.Call localVarCall = importScenarioRunValidateBeforeCall(organizationId, workspaceId, scenarioId, scenarioRun, null);
        Type localVarReturnType = new TypeToken<ScenarioRun>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * import a ScenarioRun for the Scenario (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
     ...
     */
    public okhttp3.Call importScenarioRunAsync(String organizationId, String workspaceId, String scenarioId, ScenarioRun scenarioRun, final ApiCallback<ScenarioRun> _callback) throws ApiException {

        okhttp3.Call localVarCall = importScenarioRunValidateBeforeCall(organizationId, workspaceId, scenarioId, scenarioRun, _callback);
        Type localVarReturnType = new TypeToken<ScenarioRun>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
