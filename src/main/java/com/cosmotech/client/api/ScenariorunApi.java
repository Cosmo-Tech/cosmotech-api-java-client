...
public class ScenariorunApi {
     ...
     */
    public okhttp3.Call deleteHistoricalDataOrganizationCall(String organizationId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteHistoricalDataOrganizationValidateBeforeCall(String organizationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteHistoricalDataOrganizationCall(organizationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteHistoricalDataOrganization(String organizationId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteHistoricalDataOrganizationWithHttpInfo(String organizationId) throws ApiException {
        okhttp3.Call localVarCall = deleteHistoricalDataOrganizationValidateBeforeCall(organizationId, null);
     ...
     */
    public okhttp3.Call deleteHistoricalDataOrganizationAsync(String organizationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteHistoricalDataOrganizationValidateBeforeCall(organizationId, _callback);
     ...
     */
    public okhttp3.Call deleteHistoricalDataWorkspaceCall(String organizationId, String workspaceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteHistoricalDataWorkspaceValidateBeforeCall(String organizationId, String workspaceId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteHistoricalDataWorkspaceCall(organizationId, workspaceId, _callback);
        return localVarCall;
     ...
     */
    public void deleteHistoricalDataWorkspace(String organizationId, String workspaceId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteHistoricalDataWorkspaceWithHttpInfo(String organizationId, String workspaceId) throws ApiException {
        okhttp3.Call localVarCall = deleteHistoricalDataWorkspaceValidateBeforeCall(organizationId, workspaceId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteHistoricalDataWorkspaceAsync(String organizationId, String workspaceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteHistoricalDataWorkspaceValidateBeforeCall(organizationId, workspaceId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteHistoricalScenarioRunsByScenario
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     ...
     */
    public okhttp3.Call deleteHistoricalScenarioRunsByScenarioCall(String organizationId, String workspaceId, String scenarioId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteHistoricalScenarioRunsByScenarioValidateBeforeCall(String organizationId, String workspaceId, String scenarioId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling deleteHistoricalScenarioRunsByScenario(Async)");
        }
        
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling deleteHistoricalScenarioRunsByScenario(Async)");
        }
        
        // verify the required parameter 'scenarioId' is set
        if (scenarioId == null) {
            throw new ApiException("Missing the required parameter 'scenarioId' when calling deleteHistoricalScenarioRunsByScenario(Async)");
        }
        

        okhttp3.Call localVarCall = deleteHistoricalScenarioRunsByScenarioCall(organizationId, workspaceId, scenarioId, _callback);
        return localVarCall;
     ...
     */
    public void deleteHistoricalScenarioRunsByScenario(String organizationId, String workspaceId, String scenarioId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteHistoricalScenarioRunsByScenarioWithHttpInfo(String organizationId, String workspaceId, String scenarioId) throws ApiException {
        okhttp3.Call localVarCall = deleteHistoricalScenarioRunsByScenarioValidateBeforeCall(organizationId, workspaceId, scenarioId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete all historical ScenarioRuns for the Scenario (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
     ...
     */
    public okhttp3.Call deleteHistoricalScenarioRunsByScenarioAsync(String organizationId, String workspaceId, String scenarioId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteHistoricalScenarioRunsByScenarioValidateBeforeCall(organizationId, workspaceId, scenarioId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
