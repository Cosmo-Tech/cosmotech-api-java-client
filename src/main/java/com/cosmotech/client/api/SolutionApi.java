...
public class SolutionApi {
    ...
    public okhttp3.Call addOrReplaceParameterGroupsCall(String organizationId, String solutionId, List<RunTemplateParameterGroup> runTemplateParameterGroup, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/organizations/{organization_id}/solutions/{solution_id}/parameterGroups"
            ...
            .replace("{" + "solution_id" + "}", localVarApiClient.escapeString(solutionId.toString()));
    ...
    private okhttp3.Call addOrReplaceParameterGroupsValidateBeforeCall(String organizationId, String solutionId, List<RunTemplateParameterGroup> runTemplateParameterGroup, final ApiCallback _callback) throws ApiException {
        ...
        return addOrReplaceParameterGroupsCall(organizationId, solutionId, runTemplateParameterGroup, _callback);
    ...
    private okhttp3.Call addOrReplaceParametersValidateBeforeCall(String organizationId, String solutionId, List<RunTemplateParameter> runTemplateParameter, final ApiCallback _callback) throws ApiException {
        ...
        return addOrReplaceParametersCall(organizationId, solutionId, runTemplateParameter, _callback);
    ...
    private okhttp3.Call addOrReplaceRunTemplatesValidateBeforeCall(String organizationId, String solutionId, List<RunTemplate> runTemplate, final ApiCallback _callback) throws ApiException {
        ...
        return addOrReplaceRunTemplatesCall(organizationId, solutionId, runTemplate, _callback);
    ...
    private okhttp3.Call addSolutionAccessControlValidateBeforeCall(String organizationId, String solutionId, SolutionAccessControl solutionAccessControl, final ApiCallback _callback) throws ApiException {
        ...
        return addSolutionAccessControlCall(organizationId, solutionId, solutionAccessControl, _callback);
    ...
    private okhttp3.Call createSolutionValidateBeforeCall(String organizationId, Solution solution, final ApiCallback _callback) throws ApiException {
        ...
        return createSolutionCall(organizationId, solution, _callback);
    ...
    private okhttp3.Call deleteSolutionValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteSolutionCall(organizationId, solutionId, _callback);
    ...
    public okhttp3.Call deleteSolutionRunTemplateCall(String organizationId, String solutionId, String runTemplateId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/organizations/{organization_id}/solutions/{solution_id}/runTemplates/{run_template_id}"
            .replace("{" + "organization_id" + "}", localVarApiClient.escapeString(organizationId.toString()))
            .replace("{" + "solution_id" + "}", localVarApiClient.escapeString(solutionId.toString()))
            .replace("{" + "run_template_id" + "}", localVarApiClient.escapeString(runTemplateId.toString()));
    ...
    private okhttp3.Call deleteSolutionRunTemplateValidateBeforeCall(String organizationId, String solutionId, String runTemplateId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteSolutionRunTemplateCall(organizationId, solutionId, runTemplateId, _callback);
    ...
    public okhttp3.Call downloadRunTemplateHandlerCall(String organizationId, String solutionId, String runTemplateId, RunTemplateHandlerId handlerId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/organizations/{organization_id}/solutions/{solution_id}/runtemplates/{run_template_id}/handlers/{handler_id}/download"
            ...
            .replace("{" + "solution_id" + "}", localVarApiClient.escapeString(solutionId.toString()))
            .replace("{" + "run_template_id" + "}", localVarApiClient.escapeString(runTemplateId.toString()))
            .replace("{" + "handler_id" + "}", localVarApiClient.escapeString(handlerId.toString()));
    ...
    private okhttp3.Call downloadRunTemplateHandlerValidateBeforeCall(String organizationId, String solutionId, String runTemplateId, RunTemplateHandlerId handlerId, final ApiCallback _callback) throws ApiException {
        ...
        return downloadRunTemplateHandlerCall(organizationId, solutionId, runTemplateId, handlerId, _callback);
     ...
     */
    public okhttp3.Call findAllSolutionsCall(String organizationId, Integer page, Integer size, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findAllSolutionsValidateBeforeCall(String organizationId, Integer page, Integer size, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling findAllSolutions(Async)");
        }

        return findAllSolutionsCall(organizationId, page, size, _callback);
     ...
     */
    public List<Solution> findAllSolutions(String organizationId, Integer page, Integer size) throws ApiException {
        ApiResponse<List<Solution>> localVarResp = findAllSolutionsWithHttpInfo(organizationId, page, size);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Solution>> findAllSolutionsWithHttpInfo(String organizationId, Integer page, Integer size) throws ApiException {
        okhttp3.Call localVarCall = findAllSolutionsValidateBeforeCall(organizationId, page, size, null);
     ...
     */
    public okhttp3.Call findAllSolutionsAsync(String organizationId, Integer page, Integer size, final ApiCallback<List<Solution>> _callback) throws ApiException {

        okhttp3.Call localVarCall = findAllSolutionsValidateBeforeCall(organizationId, page, size, _callback);
        Type localVarReturnType = new TypeToken<List<Solution>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call findSolutionByIdValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return findSolutionByIdCall(organizationId, solutionId, _callback);
    ...
    private okhttp3.Call getSolutionAccessControlValidateBeforeCall(String organizationId, String solutionId, String identityId, final ApiCallback _callback) throws ApiException {
        ...
        return getSolutionAccessControlCall(organizationId, solutionId, identityId, _callback);
    ...
    /**
     * Build call for getSolutionSecurity
     * @param organizationId the Organization identifier (required)
     * @param solutionId the Solution identifier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The Solution security </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> the Solution specified is unknown or you don&#39;t have access to it </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getSolutionSecurityCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/solutions/{solution_id}/security"
            .replace("{" + "organization_id" + "}", localVarApiClient.escapeString(organizationId.toString()))
            .replace("{" + "solution_id" + "}", localVarApiClient.escapeString(solutionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSolutionSecurityValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getSolutionSecurity(Async)");
        }

        // verify the required parameter 'solutionId' is set
        if (solutionId == null) {
            throw new ApiException("Missing the required parameter 'solutionId' when calling getSolutionSecurity(Async)");
        }

        return getSolutionSecurityCall(organizationId, solutionId, _callback);
     ...
     */
    public SolutionSecurity getSolutionSecurity(String organizationId, String solutionId) throws ApiException {
        ApiResponse<SolutionSecurity> localVarResp = getSolutionSecurityWithHttpInfo(organizationId, solutionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SolutionSecurity> getSolutionSecurityWithHttpInfo(String organizationId, String solutionId) throws ApiException {
        okhttp3.Call localVarCall = getSolutionSecurityValidateBeforeCall(organizationId, solutionId, null);
        Type localVarReturnType = new TypeToken<SolutionSecurity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the Solution security information (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param solutionId the Solution identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSolutionSecurityAsync(String organizationId, String solutionId, final ApiCallback<SolutionSecurity> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSolutionSecurityValidateBeforeCall(organizationId, solutionId, _callback);
        Type localVarReturnType = new TypeToken<SolutionSecurity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getSolutionSecurityUsersValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return getSolutionSecurityUsersCall(organizationId, solutionId, _callback);
    ...
    private okhttp3.Call removeAllRunTemplatesValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return removeAllRunTemplatesCall(organizationId, solutionId, _callback);
    ...
    private okhttp3.Call removeAllSolutionParameterGroupsValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return removeAllSolutionParameterGroupsCall(organizationId, solutionId, _callback);
    ...
    private okhttp3.Call removeAllSolutionParametersValidateBeforeCall(String organizationId, String solutionId, final ApiCallback _callback) throws ApiException {
        ...
        return removeAllSolutionParametersCall(organizationId, solutionId, _callback);
    ...
    private okhttp3.Call removeSolutionAccessControlValidateBeforeCall(String organizationId, String solutionId, String identityId, final ApiCallback _callback) throws ApiException {
        ...
        return removeSolutionAccessControlCall(organizationId, solutionId, identityId, _callback);
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> The Solution default visibility </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> the Solution specified is unknown or you don&#39;t have access to it </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call setSolutionDefaultSecurityCall(String organizationId, String solutionId, SolutionRole solutionRole, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/solutions/{solution_id}/security/default"
            .replace("{" + "organization_id" + "}", localVarApiClient.escapeString(organizationId.toString()))
            .replace("{" + "solution_id" + "}", localVarApiClient.escapeString(solutionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setSolutionDefaultSecurityValidateBeforeCall(String organizationId, String solutionId, SolutionRole solutionRole, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling setSolutionDefaultSecurity(Async)");
        }

        // verify the required parameter 'solutionId' is set
        if (solutionId == null) {
            throw new ApiException("Missing the required parameter 'solutionId' when calling setSolutionDefaultSecurity(Async)");
        }

        // verify the required parameter 'solutionRole' is set
        if (solutionRole == null) {
            throw new ApiException("Missing the required parameter 'solutionRole' when calling setSolutionDefaultSecurity(Async)");
        }

        return setSolutionDefaultSecurityCall(organizationId, solutionId, solutionRole, _callback);
     ...
     */
    public SolutionSecurity setSolutionDefaultSecurity(String organizationId, String solutionId, SolutionRole solutionRole) throws ApiException {
        ApiResponse<SolutionSecurity> localVarResp = setSolutionDefaultSecurityWithHttpInfo(organizationId, solutionId, solutionRole);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SolutionSecurity> setSolutionDefaultSecurityWithHttpInfo(String organizationId, String solutionId, SolutionRole solutionRole) throws ApiException {
        okhttp3.Call localVarCall = setSolutionDefaultSecurityValidateBeforeCall(organizationId, solutionId, solutionRole, null);
        Type localVarReturnType = new TypeToken<SolutionSecurity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Set the Solution default security (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param solutionId the Solution identifier (required)
     * @param solutionRole This change the solution default security. The default security is the role assigned to any person not on the Access Control List. If the default security is None, then nobody outside of the ACL can access the solution. (required)
     ...
     */
    public okhttp3.Call setSolutionDefaultSecurityAsync(String organizationId, String solutionId, SolutionRole solutionRole, final ApiCallback<SolutionSecurity> _callback) throws ApiException {

        okhttp3.Call localVarCall = setSolutionDefaultSecurityValidateBeforeCall(organizationId, solutionId, solutionRole, _callback);
        Type localVarReturnType = new TypeToken<SolutionSecurity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call updateSolutionValidateBeforeCall(String organizationId, String solutionId, Solution solution, final ApiCallback _callback) throws ApiException {
        ...
        return updateSolutionCall(organizationId, solutionId, solution, _callback);
    ...
    private okhttp3.Call updateSolutionAccessControlValidateBeforeCall(String organizationId, String solutionId, String identityId, SolutionRole solutionRole, final ApiCallback _callback) throws ApiException {
        ...
        return updateSolutionAccessControlCall(organizationId, solutionId, identityId, solutionRole, _callback);
    ...
    private okhttp3.Call updateSolutionRunTemplateValidateBeforeCall(String organizationId, String solutionId, String runTemplateId, RunTemplate runTemplate, final ApiCallback _callback) throws ApiException {
        ...
        return updateSolutionRunTemplateCall(organizationId, solutionId, runTemplateId, runTemplate, _callback);
    ...
    private okhttp3.Call uploadRunTemplateHandlerValidateBeforeCall(String organizationId, String solutionId, String runTemplateId, RunTemplateHandlerId handlerId, File body, Boolean overwrite, final ApiCallback _callback) throws ApiException {
        ...
        return uploadRunTemplateHandlerCall(organizationId, solutionId, runTemplateId, handlerId, body, overwrite, _callback);
