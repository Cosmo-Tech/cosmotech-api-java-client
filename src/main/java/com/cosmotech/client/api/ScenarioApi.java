...
public class ScenarioApi {
    ...
    /**
     * add a control acccess to the Scenario (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
    ...
    /**
     * get a control acccess for the Scenario (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
     ...
     * @param workspaceId the Workspace identifier (required)
     * @param scenarioId the Scenario identifier (required)
     * @param body the new Scenario default security. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The Scenario default visibility </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> the Scenario specified is unknown or you don&#39;t have access to it </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call setScenarioDefaultSecurityCall(String organizationId, String workspaceId, String scenarioId, String body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setScenarioDefaultSecurityValidateBeforeCall(String organizationId, String workspaceId, String scenarioId, String body, final ApiCallback _callback) throws ApiException {
        ...
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling setScenarioDefaultSecurity(Async)");
        }
        

        okhttp3.Call localVarCall = setScenarioDefaultSecurityCall(organizationId, workspaceId, scenarioId, body, _callback);
        return localVarCall;
     ...
     */
    public ScenarioSecurity setScenarioDefaultSecurity(String organizationId, String workspaceId, String scenarioId, String body) throws ApiException {
        ApiResponse<ScenarioSecurity> localVarResp = setScenarioDefaultSecurityWithHttpInfo(organizationId, workspaceId, scenarioId, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ScenarioSecurity> setScenarioDefaultSecurityWithHttpInfo(String organizationId, String workspaceId, String scenarioId, String body) throws ApiException {
        okhttp3.Call localVarCall = setScenarioDefaultSecurityValidateBeforeCall(organizationId, workspaceId, scenarioId, body, null);
        Type localVarReturnType = new TypeToken<ScenarioSecurity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setScenarioDefaultSecurityAsync(String organizationId, String workspaceId, String scenarioId, String body, final ApiCallback<ScenarioSecurity> _callback) throws ApiException {

        okhttp3.Call localVarCall = setScenarioDefaultSecurityValidateBeforeCall(organizationId, workspaceId, scenarioId, body, _callback);
        Type localVarReturnType = new TypeToken<ScenarioSecurity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
