...
public class WorkspaceApi {
     ...
     * @param organizationId the Organization identifier (required)
     * @param workspace the Workspace to import (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importWorkspaceCall(String organizationId, Workspace workspace, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/workspaces/import"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importWorkspaceValidateBeforeCall(String organizationId, Workspace workspace, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling importWorkspace(Async)");
        }
        
        // verify the required parameter 'workspace' is set
        if (workspace == null) {
            throw new ApiException("Missing the required parameter 'workspace' when calling importWorkspace(Async)");
        }
        

        okhttp3.Call localVarCall = importWorkspaceCall(organizationId, workspace, _callback);
        return localVarCall;
     ...
     */
    public Workspace importWorkspace(String organizationId, Workspace workspace) throws ApiException {
        ApiResponse<Workspace> localVarResp = importWorkspaceWithHttpInfo(organizationId, workspace);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Workspace> importWorkspaceWithHttpInfo(String organizationId, Workspace workspace) throws ApiException {
        okhttp3.Call localVarCall = importWorkspaceValidateBeforeCall(organizationId, workspace, null);
        Type localVarReturnType = new TypeToken<Workspace>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Import a workspace (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspace the Workspace to import (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call importWorkspaceAsync(String organizationId, Workspace workspace, final ApiCallback<Workspace> _callback) throws ApiException {

        okhttp3.Call localVarCall = importWorkspaceValidateBeforeCall(organizationId, workspace, _callback);
        Type localVarReturnType = new TypeToken<Workspace>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
