...
public class WorkspaceApi {
    ...
    /**
     * add a control acccess to the Workspace (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param workspaceAccessControl the new Workspace security access to add. (required)
    ...
    /**
     * get a control acccess for the Workspace (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param identityId the User identifier (required)
     ...
     * @param organizationId the Organization identifier (required)
     * @param workspaceId the Workspace identifier (required)
     * @param body the new Workspace default security. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The Workspace default visibility </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> the Workspace specified is unknown or you don&#39;t have access to it </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call setWorkspaceDefaultSecurityCall(String organizationId, String workspaceId, String body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setWorkspaceDefaultSecurityValidateBeforeCall(String organizationId, String workspaceId, String body, final ApiCallback _callback) throws ApiException {
        ...
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling setWorkspaceDefaultSecurity(Async)");
        }
        

        okhttp3.Call localVarCall = setWorkspaceDefaultSecurityCall(organizationId, workspaceId, body, _callback);
        return localVarCall;
     ...
     */
    public WorkspaceSecurity setWorkspaceDefaultSecurity(String organizationId, String workspaceId, String body) throws ApiException {
        ApiResponse<WorkspaceSecurity> localVarResp = setWorkspaceDefaultSecurityWithHttpInfo(organizationId, workspaceId, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkspaceSecurity> setWorkspaceDefaultSecurityWithHttpInfo(String organizationId, String workspaceId, String body) throws ApiException {
        okhttp3.Call localVarCall = setWorkspaceDefaultSecurityValidateBeforeCall(organizationId, workspaceId, body, null);
        Type localVarReturnType = new TypeToken<WorkspaceSecurity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setWorkspaceDefaultSecurityAsync(String organizationId, String workspaceId, String body, final ApiCallback<WorkspaceSecurity> _callback) throws ApiException {

        okhttp3.Call localVarCall = setWorkspaceDefaultSecurityValidateBeforeCall(organizationId, workspaceId, body, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceSecurity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
