...
public class TwingraphApi {
    ...
    public okhttp3.Call deleteCall(String organizationId, String graphId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/organizations/{organization_id}/delete/{graphId}"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()))
            .replaceAll("\\{" + "graphId" + "\\}", localVarApiClient.escapeString(graphId.toString()));
    ...
    public okhttp3.Call importGraphCall(String organizationId, TwinGraphImport twinGraphImport, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/import"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()));
     ...
     */
    public okhttp3.Call queryCall(String organizationId, TwinGraphQuery twinGraphQuery, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/query"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String organizationId, TwinGraphQuery twinGraphQuery, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryCall(organizationId, twinGraphQuery, _callback);
        return localVarCall;
     ...
     */
    public String query(String organizationId, TwinGraphQuery twinGraphQuery) throws ApiException {
        ApiResponse<String> localVarResp = queryWithHttpInfo(organizationId, twinGraphQuery);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> queryWithHttpInfo(String organizationId, TwinGraphQuery twinGraphQuery) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(organizationId, twinGraphQuery, null);
     ...
     */
    public okhttp3.Call queryAsync(String organizationId, TwinGraphQuery twinGraphQuery, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(organizationId, twinGraphQuery, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
