...
public class DatasetApi {
     ...
     * @param organizationId the Organization identifier (required)
     * @param dataset the Dataset to import (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importDatasetCall(String organizationId, Dataset dataset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/datasets/import"
            .replaceAll("\\{" + "organization_id" + "\\}", localVarApiClient.escapeString(organizationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importDatasetValidateBeforeCall(String organizationId, Dataset dataset, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling importDataset(Async)");
        }
        
        // verify the required parameter 'dataset' is set
        if (dataset == null) {
            throw new ApiException("Missing the required parameter 'dataset' when calling importDataset(Async)");
        }
        

        okhttp3.Call localVarCall = importDatasetCall(organizationId, dataset, _callback);
        return localVarCall;
     ...
     */
    public Dataset importDataset(String organizationId, Dataset dataset) throws ApiException {
        ApiResponse<Dataset> localVarResp = importDatasetWithHttpInfo(organizationId, dataset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Dataset> importDatasetWithHttpInfo(String organizationId, Dataset dataset) throws ApiException {
        okhttp3.Call localVarCall = importDatasetValidateBeforeCall(organizationId, dataset, null);
        Type localVarReturnType = new TypeToken<Dataset>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Import a new Dataset (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param dataset the Dataset to import (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call importDatasetAsync(String organizationId, Dataset dataset, final ApiCallback<Dataset> _callback) throws ApiException {

        okhttp3.Call localVarCall = importDatasetValidateBeforeCall(organizationId, dataset, _callback);
        Type localVarReturnType = new TypeToken<Dataset>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
