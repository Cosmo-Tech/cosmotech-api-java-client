...
public class DatasetApi {
     ...
     * @param organizationId the Organization identifier (required)
     * @param datasetId the Dataset identifier (required)
     * @param subDatasetGraphQuery the query to run (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Run a query on a dataset (asynchronously)
     * Run a query on a dataset
     * @param organizationId the Organization identifier (required)
     * @param datasetId the Dataset identifier (required)
     * @param subDatasetGraphQuery the query to run (required)
    ...
    /**
     * Get the status of twingraph import (asynchronously)
     * Get the status of a twingraph import
     * @param organizationId the Organization identifier (required)
     * @param datasetId the dataset identifier (required)
     * @param jobId the job identifier (required)
    ...
    /**
     * Refresh dataset (asynchronously)
     * Refresh ADT, Storage dataset
     * @param organizationId the Organization identifier (required)
     * @param datasetId the Dataset identifier (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Run a query on a graph instance and return the result as a json (asynchronously)
     * Run a query on a graph instance and return the result as a json
     * @param organizationId the Organization identifier (required)
     * @param datasetId the Dataset identifier (required)
     * @param datasetTwinGraphQuery the query to run (required)
    ...
    /**
     * Upload Twingraph with ZIP File (asynchronously)
     * Upload Twingraph ZIP
     * @param organizationId the Organization identifier (required)
     * @param datasetId the Dataset identifier (required)
     * @param body  (required)
