...
public class ConnectorApi {
    ...
    /**
     * Build call for importConnector
     * @param connector the Connector to import (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importConnectorCall(Connector connector, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/connectors/import";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importConnectorValidateBeforeCall(Connector connector, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'connector' is set
        if (connector == null) {
            throw new ApiException("Missing the required parameter 'connector' when calling importConnector(Async)");
        }
        

        okhttp3.Call localVarCall = importConnectorCall(connector, _callback);
        return localVarCall;
     ...
     */
    public Connector importConnector(Connector connector) throws ApiException {
        ApiResponse<Connector> localVarResp = importConnectorWithHttpInfo(connector);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Connector> importConnectorWithHttpInfo(Connector connector) throws ApiException {
        okhttp3.Call localVarCall = importConnectorValidateBeforeCall(connector, null);
        Type localVarReturnType = new TypeToken<Connector>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Import existing connector (asynchronously)
     * 
     * @param connector the Connector to import (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call importConnectorAsync(Connector connector, final ApiCallback<Connector> _callback) throws ApiException {

        okhttp3.Call localVarCall = importConnectorValidateBeforeCall(connector, _callback);
        Type localVarReturnType = new TypeToken<Connector>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
