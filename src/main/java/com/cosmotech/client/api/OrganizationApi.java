...
public class OrganizationApi {
    ...
    /**
     * Build call for getCurrentOrganizationUser
     * @param organizationId the Organization identifier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getCurrentOrganizationUserCall(String organizationId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCurrentOrganizationUserValidateBeforeCall(String organizationId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getCurrentOrganizationUser(Async)");
        }
        

        okhttp3.Call localVarCall = getCurrentOrganizationUserCall(organizationId, _callback);
        return localVarCall;
     ...
     */
    public OrganizationUser getCurrentOrganizationUser(String organizationId) throws ApiException {
        ApiResponse<OrganizationUser> localVarResp = getCurrentOrganizationUserWithHttpInfo(organizationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrganizationUser> getCurrentOrganizationUserWithHttpInfo(String organizationId) throws ApiException {
        okhttp3.Call localVarCall = getCurrentOrganizationUserValidateBeforeCall(organizationId, null);
        Type localVarReturnType = new TypeToken<OrganizationUser>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the current User information for the Organization (asynchronously)
     * 
     * @param organizationId the Organization identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getCurrentOrganizationUserAsync(String organizationId, final ApiCallback<OrganizationUser> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCurrentOrganizationUserValidateBeforeCall(organizationId, _callback);
        Type localVarReturnType = new TypeToken<OrganizationUser>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
