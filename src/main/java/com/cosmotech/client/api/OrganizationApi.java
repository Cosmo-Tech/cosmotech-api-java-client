...
public class OrganizationApi {
    ...
    /**
     * Build call for importOrganization
     * @param organization the Organization to import (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importOrganizationCall(Organization organization, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/organizations/import";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importOrganizationValidateBeforeCall(Organization organization, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organization' is set
        if (organization == null) {
            throw new ApiException("Missing the required parameter 'organization' when calling importOrganization(Async)");
        }
        

        okhttp3.Call localVarCall = importOrganizationCall(organization, _callback);
        return localVarCall;
     ...
     */
    public Organization importOrganization(Organization organization) throws ApiException {
        ApiResponse<Organization> localVarResp = importOrganizationWithHttpInfo(organization);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Organization> importOrganizationWithHttpInfo(Organization organization) throws ApiException {
        okhttp3.Call localVarCall = importOrganizationValidateBeforeCall(organization, null);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Import an organization (asynchronously)
     * 
     * @param organization the Organization to import (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call importOrganizationAsync(Organization organization, final ApiCallback<Organization> _callback) throws ApiException {

        okhttp3.Call localVarCall = importOrganizationValidateBeforeCall(organization, _callback);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
