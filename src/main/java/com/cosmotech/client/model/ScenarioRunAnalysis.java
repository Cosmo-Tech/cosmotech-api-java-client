 ...
 * ScenarioRunAnalysis
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-04-12T18:43:08.165378+02:00[Europe/Paris]")
public class ScenarioRunAnalysis {
  ...
  public static final String SERIALIZED_NAME_SIMULATION_STATE = "simulationState";
  @SerializedName(SERIALIZED_NAME_SIMULATION_STATE)
  private String simulationState;


  public ScenarioRunAnalysis analysisId(String analysisId) {
  ...
  **/
  ...
  public ScenarioRunAnalysis datasetList(List<String> datasetList) {
    
    this.datasetList = datasetList;
    return this;
  }

  public ScenarioRunAnalysis addDatasetListItem(String datasetListItem) {
  ...
  **/
  ...
  public ScenarioRunAnalysis parametersValues(List<ScenarioAnalysisParameterValue> parametersValues) {
    
    this.parametersValues = parametersValues;
    return this;
  }

  public ScenarioRunAnalysis addParametersValuesItem(ScenarioAnalysisParameterValue parametersValuesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "the Simulation Run State")
  ...
  public boolean equals(Object o) {
    ...
    ScenarioRunAnalysis scenarioRunAnalysis = (ScenarioRunAnalysis) o;
    return Objects.equals(this.analysisId, scenarioRunAnalysis.analysisId) &&
        Objects.equals(this.datasetList, scenarioRunAnalysis.datasetList) &&
        Objects.equals(this.parametersValues, scenarioRunAnalysis.parametersValues) &&
        Objects.equals(this.simulationId, scenarioRunAnalysis.simulationId) &&
        Objects.equals(this.simulationState, scenarioRunAnalysis.simulationState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(analysisId, datasetList, parametersValues, simulationId, simulationState);
  }
  ...
  public String toString() {
    ...
    sb.append("    simulationState: ").append(toIndentedString(simulationState)).append("\n");
    sb.append("}");
    return sb.toString();
  }
