...
public class Scenario {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, tags, parentId, ownerId, rootId, solutionId, runTemplateId, workspaceId, state, creationDate, lastUpdate, ownerName, solutionName, runTemplateName, datasetList, parametersValues, lastRun, parentLastRun, rootLastRun, validationStatus, security);
  }
