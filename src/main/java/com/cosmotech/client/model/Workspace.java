...
public class Workspace {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, description, version, tags, ownerId, solution, webApp, sendInputToDataWarehouse, useDedicatedEventHubNamespace, dedicatedEventHubSasKeyName, dedicatedEventHubAuthenticationStrategy, sendScenarioRunToEventHub, sendScenarioMetadataToEventHub, security);
  }
