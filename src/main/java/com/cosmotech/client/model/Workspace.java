...
public class Workspace {
  ...
  private List<String> linkedDatasetIdList = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "w-0123456789ab", value = "Workspace unique identifier generated by the API")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "o-0123456789ab", value = "Organization unique identifier under which the workspace resides")
  ...
  **/
  ...
  @ApiModelProperty(example = "MyKey", required = true, value = "technical key for resource name convention and version grouping. Must be unique")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "FranceOffice", required = true, value = "Workspace name. This name is display in the sample webApp")
  ...
  **/
  ...
  public Workspace addLinkedDatasetIdListItem(String linkedDatasetIdListItem) {
    if (this.linkedDatasetIdList == null) {
      this.linkedDatasetIdList = new ArrayList<String>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "list of dataset linked to this dataset")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1.0.0", value = "the Workspace version MAJOR.MINOR.PATCH.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "the user id which own this workspace. set by the API from Authentification service receved id")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Activate the copy of dataset on scenario creation, meaning that each scenario created in this workspace will make this copy. when false, scenario use directly the dataset specified.")
