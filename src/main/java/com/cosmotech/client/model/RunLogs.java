...
import com.cosmotech.client.model.RunLogsEntry;
...
public class RunLogs {
  ...
  private List<RunLogsEntry> logs = new ArrayList<>();
  ...
  **/
  @javax.annotation.Nonnull
  public List<RunLogsEntry> getLogs() {
    return logs;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.runId, runLogs.runId) &&
        Objects.equals(this.logs, runLogs.logs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(runId, logs);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : RunLogs.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylogs.size(); i++) {
        RunLogsEntry.validateJsonElement(jsonArraylogs.get(i));
      };
  }
