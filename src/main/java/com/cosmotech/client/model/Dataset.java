...
public class Dataset {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, ownerId, organizationId, parentId, twingraphId, main, sourceType, source, status, queries, tags, connector, fragmentsIds, validatorId, compatibility, security);
  }
