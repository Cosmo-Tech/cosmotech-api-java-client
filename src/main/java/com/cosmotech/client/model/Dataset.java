...
public class Dataset {
  ...
  private List<String> linkedWorkspaceIdList = null;
  ...
  **/
  ...
  public Dataset addLinkedWorkspaceIdListItem(String linkedWorkspaceIdListItem) {
    if (this.linkedWorkspaceIdList == null) {
      this.linkedWorkspaceIdList = new ArrayList<String>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "list of workspace linked to this dataset")
