...
public class Dataset {
  ...
  public enum IngestionStatusEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      IngestionStatusEnum.fromValue(value);
    }
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("ingestionStatus") != null && !jsonObj.get("ingestionStatus").isJsonNull()) && !jsonObj.get("ingestionStatus").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("twincacheStatus") != null && !jsonObj.get("twincacheStatus").isJsonNull()) && !jsonObj.get("twincacheStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `twincacheStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("twincacheStatus").toString()));
      }
