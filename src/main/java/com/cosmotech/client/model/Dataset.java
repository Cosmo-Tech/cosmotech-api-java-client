...
public class Dataset {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "the Connector setup bound to a Dataset")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, ownerId, organizationId, tags, connector, fragmentsIds, validatorId, compatibility);
  }
