...
import com.cosmotech.client.auth.Authentication;
import com.cosmotech.client.auth.HttpBasicAuth;
import com.cosmotech.client.auth.HttpBearerAuth;
import com.cosmotech.client.auth.ApiKeyAuth;
import com.cosmotech.client.auth.OAuth;
import com.cosmotech.client.auth.RetryingOAuth;
import com.cosmotech.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://dev.api.cosmotech.com";
    ...
    new ServerConfiguration(
      "https://api.cosmotech.com",
      "Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://staging.api.cosmotech.com",
      "Staging",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.1.1-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dev.api.cosmotech.com
     ...
     * @return a {@link com.cosmotech.client.ApiClient} object
     */
     ...
     * @throws com.cosmotech.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.cosmotech.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.cosmotech.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.cosmotech.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.cosmotech.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.cosmotech.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.cosmotech.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.cosmotech.client.ApiException If fail to serialize the request body object into a string
     */
