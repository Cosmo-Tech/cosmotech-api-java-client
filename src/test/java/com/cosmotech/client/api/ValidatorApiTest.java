...
public class ValidatorApiTest {
    ...
    public void deleteValidatorTest() throws ApiException {
        String organizationId = null;
        String validatorId = null;
        Validator response = api.deleteValidator(organizationId, validatorId);
    ...
    public void deleteValidatorRunTest() throws ApiException {
        ...
        ValidatorRun response = api.deleteValidatorRun(organizationId, validatorId, validatorrunId);
